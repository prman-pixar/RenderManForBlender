...
class RmanRenderContext(object):
    ...
    * are we rendering in the viewport?
    ...
    k_not_interactive_running = 0b1111101
    k_not_viewport_rendering = 0b1111011
    k_not_swatch_rendering = 0b1110111
    k_not_is_live_rendering = 0b1011111
    k_not_is_refining = 0b0111111
